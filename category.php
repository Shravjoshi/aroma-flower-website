  ...
  <section class="section-margin calc-60px">
      <div class="container">
        <div class="section-intro pb-60px">
          <h2><span class="section-intro__style">Aakash Kandil</span></h2>
        </div>
        <div class="row">
           <?php
                    include("inc/db.php");
                    ...
                    $view_arts_query="select * from products where category_name='Aakash Deep'";
...
<section class="section-margin calc-60px">
      <div class="container">
        <div class="section-intro pb-60px">
          <h2><span class="section-intro__style">Jute</span></h2>
        </div>
        <div class="row">
           <?php
                    include("inc/db.php");
                    ...
                    $view_arts_query="select * from products where category_name='Jute'";
                    $run=mysqli_query($db,$view_arts_query);
