...
?>
                <div class="col-lg-12">
                    ...
                    <form class="row contact_form" action="updateuser.php?id=<?php echo $id; ?>" method="post" novalidate="novalidate">
                        ...
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="company" name="company" placeholder="Company name" value="1">
                        </div>
                      ...
                      <input type="hidden" name="password" value="<?php echo $password; ?>">
                        ...
                        <div class="text-center">
                          <input type="submit" class="button button-paypal" name="register" value="Submit Data">
                        </div>
                    </form>
                </div>
                <?php } 
